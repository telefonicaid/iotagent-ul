...
/**
 * Converts the value to the corresponding type given by attribute parameter.
 * null otherwise.
 *
 * @param {String} attribute        Name of the attribute to find.
 * @param {String} value            Value of the attribute to convert.
 * @param {Object} device           Device object containing all the information about a device.
 * @return {Object}                 Attribute's value represented in the appropriate format.
 */
function convertValue(attribute, value, device) {
        ...
        for (var i in current) {
            if (current.hasOwnProperty(i)) {
                values.push({
                    ...
                    value: convertValue(i, current[i], device)
                });
            }
        }
