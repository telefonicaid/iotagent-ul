 ...
 * @param {String} protocol     Protocol for the search in the database.
 */
...
/**
 * Handles an incoming AMPQ message, extracting the API Key, device Id and attribute to update (in the case of single
 * measures) from the AMPQ topic.
 *
 * @param {String} topic        Topic of the form: '/<APIKey>/deviceId/attributes[/<attributeName>]'.
 * @param {Object} message      AMPQ message body (Object or Buffer, depending on the value).
 */
