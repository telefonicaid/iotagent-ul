...
function start(callback) {
    ...
    var options = {
        swaggerDefinition: {
            info: {
                ...
                description:
                    'This documentation explains the POST and GET requests to the route ' +
                    config.getConfig().iota.defaultResource // Description (not required)
            }
        },
     ...
     *      description: "A device can report new measures to the
     *  IoT Platform using an HTTP GET request to the /iot/d path"
     *      consumes:
     *      - "application/json"
     *      produces:
     *      - "application/json"
     ...
     *  Unknown error parsing Ultralight 2.0: "syntax_error"'
     */
     ...
     * The different sensor values ​​are sent in IoT Agent format. For example: "c|1"'
     *        type: string
     *        required: true
     *      responses:
     *        200:
     ...
     *          description: "Could not find device group"
     *        PARSE_ERROR:
     *          description: 'There was a syntax error in the
     * Ultralight request: Unknown error parsing Ultralight 2.0: "syntax_error"'
     */
