...
function start(callback) {
    ...
    const options = {
        ...
        clientId: mqttConfig.clientId ? mqttConfig.clientId : 'iotaul_' + Math.random().toString(16).substr(2, 8),
    ...
    function createConnection(callback) {
        ...
        options.clientId = mqttConfig.clientId
            ? mqttConfig.clientId
            : 'iotaul_' + Math.random().toString(16).substr(2, 8);
