...
module.exports = {
  ParseError: function(errorMsg) {
    ...
    this.message =
      'There was a syntax error in the Ultralight request: ' + errorMsg;
    this.code = 400;
  },
  UnsupportedType: function(expectedType) {
    ...
    this.message =
      "The request content didn't have the expected type [" +
  ...
  ConfigurationError: function(errorMsg) {
    ...
    this.message =
      'There was an error in the configuration file, starting the agent: ' +
      errorMsg;
    this.code = 501;
  },
  ...
  MandatoryParamsNotFound: function(paramList) {
    ...
    /*jshint quotmark: double */
    this.message =
      "Some of the mandatory params weren't found in the request: " +
  ...
  HTTPCommandResponseError: function(code, error, command) {
    ...
    this.message =
      'There was an error in the response of a device to a command [' +
      code +
      ']:' +
      error;
    this.code = 400;
