# FIWARE IoT Agent for the Ultralight 2.0 protocol
...
The ones specifically relating to Ultralight bindings are described in the following table.
...
More details, and further settings can be found within the IoT Agent for Ultralight [documentation](https://fiware-iotagent-ul.rtfd.io) itself.

## How to build your own image

The [Dockerfile](https://github.com/telefonicaid/iotagent-ul/blob/master/docker/Dockerfile) associated with this image can be used to build an image in several ways:
