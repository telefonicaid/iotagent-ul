...
*/    describe('When a measure with a timestamp arrives with an alias to TimeInstant', function() {
        ...
        beforeEach(function(done) {
            contextBrokerMock
                ...
                .post('/v2/entities/timestampedDevice/attrs', utils.readExampleFile('./test/contextRequests/timeInstantDuplicated.json'))
                .reply(200, utils.readExampleFile('./test/unit/ngsi2/contextResponses/timeInstantDuplicatedSuccess.json'));
        ...
        it('should use the provided TimeInstant as the general timestamp for the measures', function(done) {
            mqttClient.publish(
                ...
                'temperature|24.4|TimeInstant|2016-09-26T12:19:26.476659Z', null, function(error) {
                setTimeout(function() {
                    contextBrokerMock.done();
                    done();
                }, 100);
