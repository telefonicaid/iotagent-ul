    ...
    describe('When a new single measure arrives to a Device topic', function() {
        beforeEach(function() {
            contextBrokerMock
                .matchHeader('fiware-service', 'smartGondor')
                .matchHeader('fiware-servicepath', '/gardens')
                .post('/v1/updateContext', utils.readExampleFile('./test/unit/ngsi2/contextRequests/singleMeasure.json'))
                .reply(200, utils.readExampleFile('./test/unit/ngsi2/contextResponses/singleMeasureSuccess.json'));
        });
    ...
    /*describe('When a new measure arrives for an unprovisioned Device', function() {
        ...
        beforeEach(function(done) {
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .post('/v1/updateContext')
                .reply(200, utils.readExampleFile('./test/unit/ngsi2/contextResponses/multipleMeasuresSuccess.json'));


            contextBrokerMock
                .matchHeader('fiware-service', 'TestService')
                .matchHeader('fiware-servicepath', '/testingPath')
                .post('/v1/updateContext', utils.readExampleFile('./test/unit/ngsi2/contextRequests/unprovisionedMeasure.json'))
                .reply(200, utils.readExampleFile('./test/unit/ngsi2/contextResponses/unprovisionedSuccess.json'));
    ...
    describe('When a new multiple measure arrives to a Device topic with one measure', function() {
        beforeEach(function() {
            contextBrokerMock
                .matchHeader('fiware-service', 'smartGondor')
                .matchHeader('fiware-servicepath', '/gardens')
                .post('/v2/entities/Second%20MQTT%20Device/attrs', utils.readExampleFile('./test/unit/ngsi2/contextRequests/singleMeasure.json'))
                .reply(200, utils.readExampleFile('./test/unit/ngsi2/contextResponses/singleMeasureSuccess.json'));
        });
    ...
    describe('When single message with multiple measures arrive to a Device topic', function() {
        beforeEach(function() {
            contextBrokerMock
                .matchHeader('fiware-service', 'smartGondor')
                .matchHeader('fiware-servicepath', '/gardens')
                .post('/v2/entities/Second%20MQTT%20Device/attrs', utils.readExampleFile('./test/unit/ngsi2/contextRequests/multipleMeasure.json'))
                .reply(204);
        });
    ...
    describe('When a message with multiple measure groups arrives to a Device topic', function() {
        beforeEach(function() {
            ...
            contextBrokerMock
                .matchHeader('fiware-service', 'smartGondor')
                .matchHeader('fiware-servicepath', '/gardens')
                .post('/v1/updateContext', utils.readExampleFile('./test/unit/ngsi2/contextRequests/secondSingleMeasure.json'))
                .reply(200, utils.readExampleFile('./test/unit/ngsi2/contextResponses/secondSingleMeasureSuccess.json'));
        });
    ...
    describe('When multiple groups of measures arrive, with multiple attributes, to a Device topic', function() {
        beforeEach(function() {
            contextBrokerMock
                .matchHeader('fiware-service', 'smartGondor')
                .matchHeader('fiware-servicepath', '/gardens')
                .post('/v1/updateContext', utils.readExampleFile('./test/unit/ngsi2/contextRequests/multipleMeasure.json'))
                .reply(200, utils.readExampleFile('./test/unit/ngsi2/contextResponses/multipleMeasuresSuccess.json'));
    ...
    describe('When a measure with a timestamp arrives with an alias to TimeInstant', function() {
        ...
        beforeEach(function(done) {
            contextBrokerMock
                ...
                .matchHeader('fiware-servicepath', '/gardens')
                .post('/v1/updateContext')
                .reply(200, utils.readExampleFile('./test/unit/ngsi2/contextResponses/timeInstantDuplicatedSuccess.json'))
