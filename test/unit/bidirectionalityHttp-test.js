    ...
    describe('When a bidirectional attribute is set and a new value arrives to a device without endpoint', function() {
        beforeEach(function(done) {
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .post(
                    '/v1/subscribeContext',
                    utils.readExampleFile('./test//subscriptionRequests/bidirectionalSubscriptionRequest.json')
                )
                .reply(
                    200,
            ...
            contextBrokerMock = nock('http://192.168.1.1:1026')
                ...
                .post(
                    ...
                    utils.readExampleFile('./test/subscriptionRequests/simpleSubscriptionRemove.json')
                )
                .reply(
                    200,
                    utils.readExampleFile('./test/subscriptionResponses/bidirectionalSubscriptionSuccess.json')
